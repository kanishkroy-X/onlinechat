...
# 37. PROFILE / USER PROFILE LAYOUT — FUTURE FEATURE

Use the supplied Chatib profile screenshots as **layout and UX inspiration only**.

IMPORTANT:

- Do NOT reproduce any personal information visible in the screenshots.
- Do NOT hard-code real names, emails, locations, ages, usernames, or other personal data.
- Use fictional placeholders such as `RandomUser123`, `24 yrs`, `Male`, and `Country`.
- Do NOT copy Chatib branding, logo, wording, code, or exact UI.
- This profile system is a **future feature**, not part of the current MVP.
- The current MVP remains guest/no-account random text chat.

The existing product specification defines temporary nicknames rather than permanent profiles. Therefore, do not allow this future profile concept to expand the MVP scope.

## 37.1 Profile Header Layout

Use the general mobile-first structure shown in the reference screenshots:
...
The exact visual design should follow the RandomChat design system rather than copying the reference.

## 37.2 Basic Profile Information

If profiles are introduced in a future version, keep the information much smaller than the competitor's profile system.
...
Do not collect these fields in the MVP unless a future product/legal requirement actually requires them.
...
Use the reference concept of an optional "About Me" section, but keep it simple:
...
- clear edit/save states

Do not allow HTML or script injection.

## 37.4 Future Profile Attributes

The reference screenshots show many attributes such as:
...
Do **not** copy this entire system.

It would turn RandomChat into a dating/profile platform and increase unnecessary data collection.

If future profiles are added, prefer lightweight conversation-oriented information:
...
Possible future interests could be:
- Music
- Movies
- Gaming
- Technology
...
## 37.5 Recommended Future Profile Structure
...
## 37.6 Visual Direction

The reference screenshots suggest these useful layout principles:

- full-width colored header
- compact mobile-first layout
- large rectangular form fields
- rounded corners
- clear section headings
- generous vertical spacing
- simple icons
- obvious primary action
- long-scroll profile structure

Adapt these principles to RandomChat's visual system.
...
RandomChat should remain visually distinct and modern.

## 37.7 Product Scope Rule

Profile functionality is **not MVP**.

Do not add profile pages, permanent profiles, profile editing, profile photos, or profile discovery during the initial RandomChat launch.
...
Only implement this after the MVP has proven the core random-chat loop.

## 37.8 Future Profile Implementation Prompt

```text
The supplied Chatib screenshots are reference material for a future RandomChat
profile feature.

Create a modern RandomChat profile experience inspired by the general layout
principles visible in the references, but do not copy the competitor.

Use fictional placeholder data only.

Do not use any real personal information from the screenshots.
...
Do not add dating-style fields such as:
- marital status
- body type
- weight
- tattoos
...
unless a future product decision explicitly requires them.

Preferred future fields:
- nickname
- gender
- age range/eligibility where appropriate
- country only if genuinely useful
- About Me
- interests
- languages
- conversation topics
...
All profile fields must be optional unless a clear product requirement says
otherwise.

Do not introduce a permanent profile/account system into the MVP.
```

## 37.9 Reference-Screenshot Privacy Rule

The supplied screenshots contain personal information.

For all design, code, demos, screenshots, test data and documentation:

**Never use the actual information visible in the references.**
...
If a profile photo is needed for a prototype, use a generated/placeholder
avatar rather than a real person's image from the reference.

---

# 38. FINAL SCOPE REMINDER

The profile screenshots are **layout inspiration**, not an instruction to
turn RandomChat into a profile/dating platform.

The launch product remains:

**Start → Match → Talk → Next**

Everything else is secondary until that loop works reliably.
