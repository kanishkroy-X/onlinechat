...
**Version:** 1.0  
**Product type:** Anonymous/random stranger text-chat website with preference-based matching  
**Primary platform:** Responsive web — mobile, tablet, laptop, and desktop  
**Authentication:** None  
**Pricing:** Free  
...
- Subscriptions
- Premium accounts
- Complex user matching filters beyond the defined Male/Female/Anyone MVP preference system
- Dating features
- Native mobile apps
...
| FR-17 | User can select a self-declared gender for matching | P0 |
| FR-18 | User can select Male, Female, or Anyone as chat preference | P0 |
| FR-19 | Matching respects both users' selected preferences | P0 |
| FR-20 | User can switch between Light, Dark, and System themes | P0 |
| FR-21 | Theme preference persists locally | P1 |
| FR-22 | UI supports internationalization/translation keys | P0 |
| FR-23 | User can select an available interface language | P0 |
| FR-24 | Application is fully responsive across mobile, tablet, laptop, and desktop | P0 |
...
## 25. Final MVP Feature Checklist
...
- Match with Male/Female/Anyone
- Mutual preference compatibility
- Temporary matching state
- Protection against rapid repeated matching
...
**randomcaht.online is a free, anonymous-by-default random text-chat website that lets visitors quickly meet and talk to strangers without creating an account, with optional gender-based matching preferences, multilingual UI, theme selection, and a responsive experience across devices.**
